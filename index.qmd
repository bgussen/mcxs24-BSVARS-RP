...
$$
L(B^+; B_0 \mid Y; X, \Lambda) = \lvert \text{det}(B_0) \rvert^T \exp\left(-\frac{1}{2\Lambda} \sum_{n=1}^N \|b_n V_n Y - B_n X\|^2\right)
$$
...
$$
p(Y \mid X, B^+, B_0) = \int \lvert \text{det}(B_0) \rvert^T \exp\left(-\frac{1}{2\Lambda} \sum_{n=1}^N \|b_n V_n Y - B_n X\|^2\right) p(\Lambda) \, d\Lambda
$$
