...
for (i in 1:100){
  ...
  posterior_results <- generate_posteriors(lambda_posterior = lambda.post, Y, V_matrices, kappa1 = 0.01, kappa2 = 1, kappa3 = 100, kappa4 = 1)
  ...
  for (i in 1:nrow(Y)) {
    ...
    CC = B0_posterior2[ , ,S]%*%AA - Bp_posterior2[ , , S]%*%BB
