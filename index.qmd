...
To evaluate the overall kernel, we can simplify as for the basic model. Now, however, we use the posterior degrees of freedom to estimate the posterior variance of the error terms: 
