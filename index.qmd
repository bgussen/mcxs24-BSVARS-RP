...
```{r calculating the standard deviation for the Extension III model B0 matrix, echo=FALSE, eval=TRUE}

calculate_and_print_B0sd(B0_posterior4)

```

```{r calculating the standard deviation for the Extension III model Bp matrix, echo=FALSE, eval=TRUE}

calculate_and_print_Bpsd(Bp_posterior4)

```

```{r plot lagged Bp for the Extension III model, echo=FALSE, eval=TRUE}
