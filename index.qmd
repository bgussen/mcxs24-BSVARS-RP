...
```{r calculate nu for the Extension II Bayesian SVAR model}
...
```{r calculate B0 and B+ for the Extension II Bayesian SVAR model}
...
kable(results_df, format = "html", caption = "Effect of USD_Index on Economic Indicators (in elasticities)", col.names = c("Variable (elasticity w.r.t. USD_Index)", "Basic Model", "Extended Model", "Second Extension Model"), align = "c")
