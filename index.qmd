...
plot(x = NA, y = NA, xlim = c(1, length(lagged_values)), ylim = c(-0.15, 0.15), type = "n", xlab = "Lag Number", ylab = "Effect", main = plot_title)
...
kable(results_df, format = "html", caption = "Effect of a 1% Drop in USD_Index on Economic Indicators (in percentage)", col.names = c("Variable", "Basic Model", "Extended Model"), align = "c")
