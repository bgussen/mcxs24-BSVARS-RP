...
samples = sample_lambda(nrow(y)-1, 2000)
...
initial_nu <- ncol(y) + nrow(y) # The number of variables in the Bayesian SVAR model, this is based on the set up of the normal-generalized-normal distribution from the basic model. 
...
samples = sample_lambda(selected_nu_mode, 2000)
...
for (i in 2:4) {
  ...
  second_extension_effect <-  B0.posterior3[i, 1, S] / B0.posterior3[i, i, S]
